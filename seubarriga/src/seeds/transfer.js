...
exports.seed = (knex) => {
  return knex( 'transactions' ).del()
    ...
    .then( () => knex( 'users' ).insert([
      { id: 10000, name: 'User #1', mail: 'user1@mail.com', passwd: '$2a$10$Q2WSCcJQquHAPSqKjiSCo.03FWBfGORlQeSPKL4iy61r.VRLFvtiK' },
      { id: 10001,  name: 'User #2', mail: 'user2@mail.com', passwd: '$2a$10$Q2WSCcJQquHAPSqKjiSCo.03FWBfGORlQeSPKL4iy61r.VRLFvtiK' },
    ]))
